...
The [next post](/ITStrategy/2019/11/13/case-continuous-improvement-deeper-dive.html) is intended for the more committed reader to try and more deeply explore the outputs desired from continually improving, and what we should take into consideration when doing so.
