...
4. [Micro-Acquisition (GCDevExchange 2.0)](https://014gc.sharepoint.com/sites/GCDevEx): a strategy that seeks to provide the department and suppliers with a light-weight, low dollar value (&lt; $10k) contract amount, acquisition process. Resulting work from such contract is to be made available under an Open Source licence.
