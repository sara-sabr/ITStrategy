...
If a client changed her mind during this execution phase, the impact to the project was high.
...
Though we think those are not necessarily about success rates, they are about the reality that change is inevitable, that having such foresight is extremely rare, and that it is nearly impossible to plan that far into the future.
...
The longer the organization is locked in a project, the greater the risk being locked into a potentially bad idea.
