...
Criteria are established to guide investment decision makers on whether a particular investment proposal is ripe for this new funding model approach (similarly to [block funding](https://www.innovationpolicyplatform.org/content/block-funding/index.html)). Some of these criteria could include:
