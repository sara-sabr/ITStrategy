...
Rencontrez des personnes qui mènent des initiatives similaires ou connexes, comme [l'équipe d'échange de développeurs de la C.-B. (anglais seulement)](https://bcdevexchange.org/), le paiement en 15 jours de SPAC, le marché numérique de Services partagés Canada ou [TechNation (anglais seulement)](https://technationcanada.ca/en/digital-marketplace/), les initiatives d'approvisionnement et d'emploi en TI autochtones (à EDSC et à SPAC) pour rechercher des synergies et partager les leçons apprises.
