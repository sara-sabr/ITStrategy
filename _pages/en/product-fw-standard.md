...
This **PILOT** standard only applies to Job Bank and the MyESDC mobile application and **is effective between April 1st 2022 and March 31st 2023**.
...
The following standards are used pursuant the [PILOT IITB Directive on Product Management](product-fw-directive.html).

### Head of Product Role

The Head of Product oversees all of the product-related work that the Product Team does.
It's the person at the top of all other internal or smaller products making up the main Product the team is ultimately responsible for.

A Head of Product is expected to be executive level due to the oversight and responsibilities expected of it.
...
The Product Manager is a strategic role.
Will typically look at a time horizon beyond 3-6 months.
It's the person assigned responsibility for overseeing all of the various activities that concern a particular product.
...
- Works closely with the Product Owner and team members to ensure business case and client satisfaction goals are met
...
The above taken from [Product Development and Management Association](https://www.pdma.org/?)'s Body of Knowledge second edition, from [280group](https://280group.com/what-is-product-management/roles/product-manager/), [GOV.uk's guidance](https://www.gov.uk/guidance/product-manager).

### Product Owner Role

The Product Owner is a tactical role.
Will typically look at a time horizon within 3-6 months.
The Product Owner interfaces with, and engages the business stakeholders.

The Product Owner is the final authority for decisions regarding priority, business value, and functionality for the work done by the Product Development team.

The Product Owner performs the following activities:

- Acts as a fully integrated team member
- Uses clear goals to communicate the internal project (release scope) vision at the beginning of every release so that the team understands and is equipped to realize it
...
- Works closely with IT Managers in taking the technical aspect of each release scope
...
The above from [Info-Tech Research Group](https://www.infotech.com/research/it-product-owner).

### IT Security Champion Role

The IT Security Champion is the go-to-person for IT Security knowledge about the product.

The IT Security Champion performs the following activities:

- Understands the security tools
- Implements security tools in the pipeline
...
The above from [SLF's January 2021 presentation](https://014gc.sharepoint.com/:p:/r/sites/DGIIT-Gouvernance-IITB-Governance/SLFFCS/DevSecOps SLF-EN.pptx?d=wc4a2579808df446eab5b3b5b3ceedb5f&csf=1&web=1&e=VVS26e) (modified last point)

### Change Coordinator Role

The Change Coordinator ensures that all changes are managed in a controlled manager, including standard changes and emergency maintenance.

The Change Coordinator performs the following activities:

- Performs impact assessments
- Seeks the necessary authorisations prior to the change (e.g. IITB Release Process)
- Ensures all stakeholders are aware of the upcoming product release
- Documents the change

The above from [Info-Tech Research Group](https://www.infotech.com/research/change-manager).
...
- Liaise with IITB's Software Product Specialists, if need be, when COTS software product are being used

### Product Team Organizational Structure

The Product Team Organizational Structure represents the cross-branch Org Chart of the product team.

It identifies which positions, from the ESDC branches involved, that makes up the Product Team.

### Product Team Governance Structure

The Product Team's Governance Structure explains how decisions affecting the product are managed.
A governance structure will typically contain committees and individuals performing specific roles (such as the relationships between the different roles mentioned above).
The Governance structure also explains how certain decisions may be delegated.
...
The Product Roadmap Executive View includes the following information:

- A Fiscal Year view, by month, of the product's timespan
- Each milestone expected in the year (estimated month of release)
- A brief summary of the outcomes sought for each milestone
...
| Analysis                        | Analysis evaluating the expected outcome(s) of the Release, whether positive or negative, sustained by evidence|
...
A risk register is a document that documents risks related to the product(s) and the mitigation plan for each.
