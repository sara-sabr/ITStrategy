...
### Favoriser la souplesse organisationnelle (EDSC) <!-- omit in toc -->
...
### Accélérer l’acquisition de solutions et de produits TI (LL, XaaS, etc.) <!-- omit in toc -->
...
### Accroître la réutilisation des solutions et produits de TI existants, internes et externes <!-- omit in toc -->
...
### Créer des solutions conçues pour le nuage <!-- omit in toc -->
...
### Concevoir ou acheter : Une question trop simplifiée <!-- omit in toc -->
...
### Autres considérations <!-- omit in toc -->
...
### Évaluation du coût total de possession <!-- omit in toc -->
...
### Journal des changements <!-- omit in toc -->
