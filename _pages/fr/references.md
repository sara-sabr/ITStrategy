...
- [Certifications AWS](https://aws.amazon.com/certification/) : Toute une série de certifications AWS, dont celles d'architecte de solutions, d'administrateur SysOps, d'ingénieur DevOps, de spécialiste en apprentissage machine, de spécialiste des données volumineuses, etc. De nombreux documents en ligne sont disponibles pour l'étude, notamment [AWS Tutorial Series](https://www.youtube.com/channel/UClLLJjpSWRRa1BosQrNVDjA) et leur propre documentation, comme le [AWS Well-Architected Framework](https://aws.amazon.com/architecture/well-architected/). La certification la plus populaire est la [Associate Solutions Architecture Certification](https://aws.amazon.com/certification/certified-solutions-architect-associate/) et un cours en ligne gratuit est disponible [ici](https://www.youtube.com/watch?v=Ia-UEYYR44s&list=WL&index=28&t=615s).
- [Azure Certifications](https://www.microsoft.com/en-us/learning/azure-exams.aspx) : Propose une liste de certifications et de formations en ligne pour se préparer. Par exemple, des cours sur [Developing Solutions for Microsoft Azure](https://docs.microsoft.com/fr-fr/learn/certifications/exams/az-204?wt.mc_id=learningredirect_certs-web-wwl) qui est suivi d'une section "Ways to prepare" avec du contenu à étudier.
...
[LinkedIn Workplace Learning & Development Report 2018](https://learning.linkedin.com/resources/workplace-learning-report-2018) (Rapport - Sondage de ≈4,000 professionnels)  
